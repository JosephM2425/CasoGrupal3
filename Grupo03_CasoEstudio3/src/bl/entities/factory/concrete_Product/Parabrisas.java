...
public class Parabrisas extends Repuesto{
    public Parabrisas(int id_Repuesto, TipoRepuesto tipoRepuesto, String descripcion, String categoria, float precio, MarcaRepuesto marcaRepuesto) {
    ...
    public Parabrisas(TipoRepuesto tipoRepuesto, String descripcion, String categoria, float precio, MarcaRepuesto marcaRepuesto) {
        setTipoRepuesto(tipoRepuesto);
        setNombre("Parabrisas "+ marcaRepuesto);
        setDescripcion(descripcion);
        setCategoria(categoria);
