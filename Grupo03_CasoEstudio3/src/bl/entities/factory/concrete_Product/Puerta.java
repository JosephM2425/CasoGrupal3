...
public class Puerta extends Repuesto{
    public Puerta(int id_Repuesto, TipoRepuesto tipoRepuesto, String descripcion, String categoria, float precio, MarcaRepuesto marcaRepuesto) {
    ...
    public Puerta(TipoRepuesto tipoRepuesto, String descripcion, String categoria, float precio, MarcaRepuesto marcaRepuesto) {
        setTipoRepuesto(tipoRepuesto);
        setNombre("Puerta "+ marcaRepuesto);
        setDescripcion(descripcion);
        setCategoria(categoria);
